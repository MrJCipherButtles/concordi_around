...
void main() {
  group('shortest path', () {
    ...
    var z = PortalCoordinate(45.49748, -73.57885, '1', 'Hall', 'SGW');
    var zz = PortalCoordinate(45.49753, -73.57893, '1', 'Hall', 'SGW');
    ...
    test('shortest path from f to e', () {
      expect(floor.shortestPath(f, e).toString(),
          Path([f, a, b, c, y, d, e]).toString());
    });
